      ...
      <section className="bg-gradient-to-br from-orange-50 to-orange-100 border-b border-orange-100">
        <div className="max-w-4xl mx-auto px-6 py-16 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-10">
            {[
              { icon: "🎁", label: "Free delivery", sub: "on orders over £25" },
              { icon: "⏱️", label: "Dispatched in", sub: "2 working days" },
      ...
      <div className="max-w-4xl mx-auto px-6 py-14 space-y-16">
        ...
        <div className="bg-gradient-to-r from-brand-green to-green-600 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-center gap-4 text-white">
          ...
          <div className="flex-1 text-center md:text-left">
            <h2 className="text-2xl font-extrabold mb-1">Free delivery on orders over £25</h2>
            <p className="text-green-100 text-sm">Spend £25 or more and we'll cover your standard delivery cost automatically at checkout. No code needed.</p>
          </div>
        ...
        <section className="bg-white rounded-2xl border border-gray-100 p-6 md:p-8">
          ...
          <p className="text-gray-600 text-sm leading-relaxed mb-4">
            During major Indian festivals such as Diwali, Raksha Bandhan, and Holi, we experience significantly higher order volumes. While we always aim to dispatch within 2 working days, we recommend ordering early during these periods to avoid any disappointment.
          </p>
          <p className="text-gray-600 text-sm leading-relaxed">
