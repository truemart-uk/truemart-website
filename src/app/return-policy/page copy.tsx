    ...
    content: [
      {
        ...
        label: "TrueMart Products",
        items: [
          "Email contact@truemart.co.uk with your return request and order number",
    ...
    content: [
      {
        ...
        items: [
          ...
          "Email contact@truemart.co.uk as soon as possible with your order number",
      ...
      <section className="max-w-4xl mx-auto px-6 py-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { icon: "📧", title: "Email Us", desc: "contact@truemart.co.uk" },
          ].map((card) => (
        ...
        {sections.map((section) => (
          <div key={section.id} id={section.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div className="flex items-start justify-between p-6 border-b border-gray-50">
              ...
              {section.ukLaw && (
                <span className="hidden md:inline-flex items-center gap-1.5 bg-blue-50 text-blue-600 text-xs font-semibold px-3 py-1 rounded-full border border-blue-100 flex-shrink-0 ml-4">
                  ⚖️ {section.ukLaw}
                </span>
              )}
            </div>
