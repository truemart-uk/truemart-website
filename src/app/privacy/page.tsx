          ...
          <div className="lg:col-span-3 space-y-12 text-sm text-gray-600 leading-relaxed">
            ...
            <section id="your-rights">
              ...
              <div className="bg-orange-50 border border-orange-100 rounded-xl p-4">
                <p className="text-sm text-gray-700">To exercise any of these rights, contact us at <a href={`mailto:${SITE.contact.email}`} className="text-brand-orange font-semibold hover:underline">{SITE.contact.email}</a>. We will respond within <strong>one calendar month</strong> as required by UK GDPR. We may ask you to verify your identity before processing your request.</p>
              </div>
            </section>
            ...
            <section id="children">
              ...
              <p>Our website and services are not directed at children under the age of 13. We do not knowingly collect personal data from children. If you believe we have inadvertently collected data from a child, please contact us immediately at <a href={`mailto:${SITE.contact.email}`} className="text-brand-orange hover:underline">{SITE.contact.email}</a> and we will delete it promptly.</p>
            </section>
