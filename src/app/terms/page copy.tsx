          ...
          <div className="lg:col-span-3 space-y-12 text-sm text-gray-600 leading-relaxed">
            ...
            <section id="about">
              ...
              <div className="bg-white border border-gray-100 rounded-xl p-5 space-y-1 mb-3">
                ...
                <p>Email: <a href={`mailto:${SITE.contact.email}`} className="text-brand-orange hover:underline">{SITE.contact.email}</a></p>
                <p>Phone: <a href={`tel:${SITE.contact.phone.replace(/\s/g, "")}`} className="text-brand-orange hover:underline">{SITE.contact.phone}</a></p>
              </div>
            ...
            <section id="account">
              ...
              <ul className="space-y-2 mb-3">
                {[
                  ...
                  `You must notify us immediately if you suspect unauthorised access to your account at ${SITE.contact.email}`,
            ...
            <section id="cancellation">
              ...
              <ul className="space-y-2 mb-3">
                {[
                  `To cancel, contact us at ${SITE.contact.email} before or within 14 days of receiving your order, clearly stating your order number and your intention to cancel.`,
            ...
            <section id="returns">
              ...
              <ul className="space-y-2 mb-3">
                {[
                  `Contact us within 48 hours of delivery at ${SITE.contact.email} with your order number and clear photographs of the issue.`,
            ...
            <section id="governing-law">
              ...
              <p className="mb-3">
                We are committed to resolving disputes fairly and promptly. If you have a complaint, please contact us first at <a href={`mailto:${SITE.contact.email}`} className="text-brand-orange hover:underline">{SITE.contact.email}</a>. We will acknowledge your complaint within 3 working days and aim to resolve it within 14 days.
              </p>
              <p>
